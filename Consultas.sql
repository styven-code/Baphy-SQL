...
select book.title, book.author, book.language, book.edition, category.name_category, client_book.price, client.names, client.lastnames, users.email, contact.phone
...
inner join baphystore.contact on client.id = contact.id_client
